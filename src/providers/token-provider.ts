...
export const DAI_ON = (chainId: ChainId): Token => {
  switch (chainId) {
    ...
    case ChainId.ABSTRACT:
      // DAI not available on Abstract mainnet, return USDC instead
      return USDC_ABSTRACT;
    case ChainId.ABSTRACT_TESTNET:
      // DAI not available on Abstract testnet, return USDC instead
...
export const USDT_ON = (chainId: ChainId): Token => {
  switch (chainId) {
    ...
    case ChainId.ABSTRACT:
      return USDT_ABSTRACT;
    case ChainId.ABSTRACT_TESTNET:
      // USDT not available on Abstract testnet, return USDC instead
      return USDC_ABSTRACT_TESTNET;
    default:
      throw new Error(`Chain id: ${chainId} not supported`);
  }
