...
describe('quote for other networks', () => {
  const TEST_ERC20_1: { [chainId in ChainId]: Token } = {
    ...
    [ChainId.ABSTRACT]: USDC_ABSTRACT,
  ...
  const TEST_ERC20_2: { [chainId in ChainId]: Token } = {
    ...
    [ChainId.MOONBEAM]: WBTC_MOONBEAM,
    [ChainId.ABSTRACT]: USDT_ABSTRACT,
    [ChainId.ABSTRACT_TESTNET]: WETH_ABSTRACT_TESTNET,
  };
  ...
  for (const chain of _.filter(
    ...
    (c) =>
      ...
      // Abstract chains are new and may not have sufficient liquidity pools yet
      c != ChainId.ABSTRACT &&
