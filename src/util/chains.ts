...
export const NATIVE_CURRENCY: { [chainId: number]: NativeCurrencyName } = {
  ...
  [ChainId.ABSTRACT]: NativeCurrencyName.ETHER,
...
export const ID_TO_PROVIDER = (id: ChainId): string => {
  switch (id) {
    ...
    case ChainId.ABSTRACT:
      return (
        process.env.JSON_RPC_PROVIDER_ABSTRACT || 'https://api.mainnet.abs.xyz'
      );
    case ChainId.ABSTRACT_TESTNET:
      return (
        process.env.JSON_RPC_PROVIDER_ABSTRACT_TESTNET ||
